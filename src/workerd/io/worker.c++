...
struct Worker::Actor::Impl {
  ...
  struct ScheduledAlarm {
    ScheduledAlarm(kj::Date scheduledTime,
        kj::PromiseFulfillerPair<WorkerInterface::AlarmResultWithException> pf)
    ...
    kj::ForkedPromise<WorkerInterface::AlarmResultWithException> resultPromise;
    kj::Promise<void> cleanupPromise = resultPromise.addBranch().then(
        [](WorkerInterface::AlarmResultWithException&&) {}, [](kj::Exception&&) {});
...
kj::Maybe<kj::Promise<WorkerInterface::AlarmResultWithException>> Worker::Actor::getAlarm(
    kj::Date scheduledTime) {
...
kj::Promise<WorkerInterface::ScheduleAlarmResult> Worker::Actor::scheduleAlarm(
  ...
  auto& scheduledAlarm = impl->maybeScheduledAlarm.emplace(
      scheduledTime, kj::newPromiseAndFulfiller<WorkerInterface::AlarmResultWithException>());
