...
WorkerInterface::AlarmFulfiller::AlarmFulfiller(
    kj::Own<kj::PromiseFulfiller<AlarmResultWithException>> fulfiller)
...
void WorkerInterface::AlarmFulfiller::fulfill(const AlarmResultWithException& result) {
  KJ_IF_SOME(fulfiller, getFulfiller()) {
...
void WorkerInterface::AlarmFulfiller::cancel() {
  KJ_IF_SOME(fulfiller, getFulfiller()) {
    fulfiller.fulfill(AlarmResultWithException{
      .retry = false,
...
kj::Maybe<kj::PromiseFulfiller<WorkerInterface::AlarmResultWithException>&> WorkerInterface::
    AlarmFulfiller::getFulfiller() {
